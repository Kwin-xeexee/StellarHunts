 ...
 *
 * Because AnalyticsService accepts an optional ConfigService (no Redis when
...
function freshService(): AnalyticsService {
...
describe('AnalyticsService — property-based', () => {
